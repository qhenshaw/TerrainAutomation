...
namespace TerrainAutomation
{
    ...
    public class LoftRiverBehaviour : MonoBehaviour
    {
        [SerializeField]
        ...
        public void LoftAllRoads()
        {
            ...
            WaterSurface water = GetComponent<WaterSurface>();
            water.surfaceType = WaterSurfaceType.River;
        ...
        public void Loft(Spline spline, int widthDataIndex)
        {
            ...
            for (int i = 0; i < steps; i++)
            {
                ...
                pos += new float3(0f, m_Verticaloffset, 0f);
